...
module.exports = {
  data: new SlashCommandBuilder().setName('top-şarkılar').setDescription('Sunucudaki en popüler şarkıları gösterir'),
  ...
  async execute(interaction) {
    ...
    await interaction.reply({ embeds: [baseEmbed().setTitle('🏆 Sunucunun Top Şarkıları').setDescription(list)] });
  }
};
